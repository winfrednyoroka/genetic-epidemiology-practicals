...
# We pass to R the CLEAN GWAS results file and the filename for the graphs to be saved to
...
Rscript ${workdir}/gwas_graphs.R ${outdir}/clean.BMI.glm.linear.add ${outdir}/clean_bmi
