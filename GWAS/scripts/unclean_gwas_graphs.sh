...
Rscript gwas_graphs.R ~/scratch/genetic-epidemiology-practicals/GWAS/output/bmi.BMI.glm.linear.add ~/scratch/genetic-epidemiology-practicals/GWAS/output/bmi_unclean
